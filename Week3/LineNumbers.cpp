...
int main() {
    ...
    getline(cin, inputFileName); //user inputs input file name
    ...
    getline(cin, outputFileName); //user inputs output file name
    ...
    cout << "The line numbers have been added to the output file!" << endl;
