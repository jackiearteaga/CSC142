...
int main() {
    Inventory inventory(10); //inventory object of size 10

    //add books to the inventory (I chose popular romance books)
    inventory.addBook(Book("9780141439518", "Jane Austen", "Pride and Prejudice", 1, "PE", 9.99));
    inventory.addBook(Book("9781455582871", "Nicholas Sparks", "The Notebook", 1, "AW", 14.99));
    inventory.addBook(Book("9780143124542", "Jojo Moyes", "Me Before You", 1, "PE", 12.99));
    inventory.addBook(Book("9780316015844", "Stephenie Meyer", "Twilight", 1, "PH", 10.99));
    inventory.addBook(Book("9780525478812", "John Green", "The Fault in Our Stars", 1, "NS", 13.99));
    inventory.addBook(Book("9781443417366", "Graeme Simsion", "The Rosie Project", 1, "PG", 15.50));

    std::cout << "Initial Inventory:\n"; //initial inventory
    inventory.printInventory();

    // price change
    inventory.changePrice("9780141439518", 7.50);  //Pride and Prejudice
    inventory.changePrice("9781455582871", 10.00); //The Notebook
    inventory.changePrice("9780316015844", 8.50);  //Twilight
